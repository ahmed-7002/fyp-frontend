...
import { FocusModeProvider } from "./lib/FocusModeContext.jsx";

export default function App() {
  return (
    <ThemeProvider>
      <AssessmentProvider>
        {/* Wraps both Navbar and the routes below so the exercise page can
           reach into the same focus-mode state Navbar reads from - they're
           siblings here, not parent/child, hence the shared context. */}
        <FocusModeProvider>
          <Navbar />
          <main>
            <Routes>
